...
const CompanyRegister = () => {
    ...
    const [validCompanyTitle, setValidCompanyTitle] = useState(false);
    ...
    useEffect(() => {
        const tresult = companyTitle.length > 7
        setValidCompanyTitle(tresult);
        const presult = password.length > 7
        setValidPassword(presult);
        setErrorMessage('');
    }, [companyTitle, password])
        ...
        <>
            ...
            <div className="container">
                ...
                <div className="register-form">
                    ...
                    {!validCompanyTitle && companyTitle && <p className="error-instructions" id="uidnote">Company title should be atleast 8 characters!</p>}
